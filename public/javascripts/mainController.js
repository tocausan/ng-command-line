app.controller('mainController', function($scope, $http, $filter) {
    ...
    * */
    $scope.bash = [
        ...
        {id: 2, command: 'help', info: "Help you a bit", response: "This is a virtual command-line, if you need help type \"man\", it will show you some commands."},
        {id: 3, command: 'info', info: "Info about it", response: "Hi, I'm your here to tell you beautiful stories ;)"},
        {id: 3, command: 'contact', info: "Contact me", response: "tomascaufriez@gmail.com, for the rest google-ise \"tocausan\" I'm pretty sure you would figure it out."},
    ]
